...
| 序号 | 内容 | 完成清况 |
| ------- | ------- | ------- |
| 1 | 功能:删除ip工具和ping工具 | 这个简单 |
| 2 | 功能:加入模版管理模块 | emm... |
| 3 | 功能:更新检测 | 已经准备好api和检测代码了 |
| 4 | 功能:隧道离线消息推送 | 代码已经准备就绪 |
| 5 | api:API状态 | 代码已经准备就绪 |
| 6 | api:官方消息推送和显示 | 代码已经准备就绪 |
| 7 | api:基于 内网穿透.中国 的黑名单api对用户进行警告 | 代码已经准备就绪 |
| 8 | bug:隧道id是唯一标识，隧道自启动要以id为准 | 这个简单 |
| 9 | 功能:隧道分组好统一操作 | 这个简单个p |
| 10 | 功能:违规用户展示 | api已经准备好了 |
