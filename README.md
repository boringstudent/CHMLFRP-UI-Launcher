...
| ------- | ------- | ------- |
| 1 | 功能:加入模版管理模块 | emm... |
| 2 | 功能:更新检测 | 已经准备好api和检测代码了 |
| 3 | 功能:隧道离线消息推送 | 代码已经准备就绪 |
| 4 | api:API状态 | 代码已经准备就绪 |
| 5 | api:官方消息推送和显示 | 代码已经准备就绪 |
| 6 | api:基于 内网穿透.中国 的黑名单api对用户进行警告 | 代码已经准备就绪 |
| 7 | bug:隧道id是唯一标识，隧道自启动要以id为准 | 这个简单 |
| 8 | 功能:隧道分组好统一操作 | 这个简单个p |
| 9 | 功能:违规用户展示 | api已经准备好了 |
